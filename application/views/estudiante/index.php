    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" style="color:#fff" href="http://phpcrud.local/">Home</a>
        </div>
                            ...
                            <div class="col-md-9">
                                <div class="radio">
                                    <label>
                                        <?php
                                        foreach($list as $value){
                                        echo '<input type="radio" name="univ_nombre" value="">' . $value->carr_id . "<br>";
                                        }
                                        ?>
                                    </label>
                                </div>
                            ...
                            <div class="col-md-9">
                                <div class="checkbox">
                                    <label>
                                        <?php
                                        foreach($list as $value){
                                        echo '<input type="checkbox" value="">' . $value->carr_id . "<br>";
                                        }
                                        ?>
                                    </label>
                                </div>
